  ...
  return (
    <>
      ...
      <div className="my-8 flex flex-col items-center md:flex-row md:justify-center md:items-stretch md:mx-auto px-4 md:max-w-4xl">
        <motion.div
          className="flex flex-col rounded-lg justify-end w-full md:w-7/12 h-auto overflow-x-hidden pt-2"
          style={{ background: "#383440", x: isMobile ? 0 : assembleX }}
        >
        ...
        <motion.div
          ...
          style={{ background: "#383440", x: isMobile ? 0 : bringOnX }}
        >
          <div className="px-10">
